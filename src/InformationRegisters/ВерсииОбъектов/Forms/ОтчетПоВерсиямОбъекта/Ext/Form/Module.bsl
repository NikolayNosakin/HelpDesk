	...
	Пока ЧтениеXML.Прочитать() Цикл
		...
		ИначеЕсли ЧтениеXML.ТипУзла = ТипУзлаXML.Текст Тогда
			Если (УровеньЧтения = 2) Тогда // значение реквизита
				...
				//АбисСофт-Кострицын Олег-Старт 1 декабря 2012 г.
				//При получении хранилища из хранилища платформа вылетает!
				Если НовоеЗр.Тип <> Тип("ХранилищеЗначения") Тогда
					 НовоеЗР.ЗначениеРеквизита = ?(ЗначениеЗаполнено(НовоеЗР.Тип), XMLЗначение(НовоеЗР.Тип, ЧтениеXML.Значение), ЧтениеXML.Значение);
				КонецЕсли;
				//АбисСофт-Кострицын Олег-Финиш 1 декабря 2012 г.
